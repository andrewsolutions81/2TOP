...
function StoreComponent(){//mayuscula al ser componente// este provee el contexto

  function percentage() {
    const totalVotes = (initialState.c1 + initialState.c2 +initialState.c3 + initialState.c4)
